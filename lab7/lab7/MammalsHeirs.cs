...
namespace lab7
{
    ...
    public class Croc : IAnimal
    {
        ...
        public void eat()
        {
            Console.WriteLine("Croc eats meat.");
        }

        public int move()
        {
            position += 1;
            Console.WriteLine($"Croc moved to {position}.");
            return position;
        }

        public void sleep()
        {
            Console.WriteLine($"CROC'S WATCHIN YA.");
        }
    ...
    public sealed class Parrot : Bird
    {
        ...
        public override void eat()
        {
            Console.WriteLine("Parrot eats breadcrumbs and drinks water.");
        }
    ...
    //public class AnotherTypeOfParrot: Parrot { } Попугай запечатан, поэтому невозможно создать производный класс
